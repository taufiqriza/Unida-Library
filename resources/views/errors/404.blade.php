...
<body class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 pattern-bg overflow-hidden">
    {{-- Decorative Blobs --}}
    <div class="blob w-72 h-72 bg-blue-400 top-20 -left-20"></div>
    <div class="blob w-96 h-96 bg-purple-400 -bottom-32 right-20" style="animation-delay: -4s;"></div>
    <div class="blob w-64 h-64 bg-pink-400 top-1/2 right-1/4" style="animation-delay: -2s;"></div>
    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div class="floating mb-8">
            <div class="relative">
                ...
                <div class="flex items-end justify-center gap-2 mb-6">
                    ...
                    <div class="w-10 h-32 bg-gradient-to-b from-purple-400 to-purple-600 rounded-t-sm shadow-lg"></div>
                    <div class="w-8 h-20 bg-gradient-to-b from-pink-400 to-pink-600 rounded-t-sm transform rotate-6 shadow-lg"></div>
                    <div class="w-6 h-16 bg-gradient-to-b from-emerald-400 to-emerald-600 rounded-t-sm transform rotate-12 shadow-lg"></div>
                </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="/" 
               class="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
    ...
    <script>
        ...
        for (let i = 0; i < particleCount; i++) {
            ...
            particle.className = 'absolute w-2 h-2 bg-blue-300/30 rounded-full';
