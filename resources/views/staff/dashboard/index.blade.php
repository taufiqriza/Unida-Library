...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-5 text-white">
            ...
            <p class="text-3xl font-bold">{{ $stats['loans_today'] }}</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-5 text-white">
            ...
            <p class="text-3xl font-bold">{{ $stats['returns_today'] }}</p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            ...
            <p class="text-3xl font-bold text-amber-600">Rp {{ number_format($stats['unpaid_fines']/1000, 0) }}K</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['total_books']) }}</p>
