        ...
        <div class="w-full max-w-4xl">
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 overflow-hidden">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-primary-600 to-primary-800 p-8 flex-col text-white">
                    ...
                    <div class="lg:w-7/12">
                        ...
                        <div class="p-6 lg:p-8">
                            ...
                            <a href="{{ route('auth.google') }}" class="w-full py-3.5 bg-white border-2 border-gray-200 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition">
                            ...
                            <p class="text-xs text-gray-500 text-center mt-2">
                                ...
                                {{ __('opac.auth.login.google_hint') }}
                            </p>
                            <p class="text-xs text-gray-500 text-center mt-1 mb-5">
