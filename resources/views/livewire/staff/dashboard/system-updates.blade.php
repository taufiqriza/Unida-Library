            ...
            <div class="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border border-blue-200/60 rounded-3xl shadow-2xl max-w-3xl w-full max-h-[85vh] overflow-hidden">
                ...
                <div class="p-6 max-h-96 overflow-y-auto bg-gradient-to-b from-blue-50/50 to-indigo-50/30">
                    ...
                    <div class="grid md:grid-cols-2 gap-3 mb-4">
                        {{-- Google Account Card --}}
                        <div class="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/60 rounded-xl shadow-sm">
                            ...
                            <div class="flex flex-col flex-1">
                                ...
                                @else
                                    ...
                                    <a href="{{ route('auth.google') }}" class="text-xs text-blue-700 hover:text-blue-800 font-semibold leading-tight">Hubungkan Google →</a>
                                @endif
                            </div>
                        </div>
