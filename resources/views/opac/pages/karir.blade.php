    ...
    <section class="max-w-4xl mx-auto px-4 py-6 lg:py-10">
        ...
        <div class="grid grid-cols-3 gap-3 lg:gap-4 mb-6 lg:mb-8">
            <div class="text-center p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <h3 class="font-semibold text-gray-900 text-xs lg:text-sm">Pengembangan</h3>
                <p class="text-[10px] lg:text-xs text-gray-500 mt-1 hidden sm:block">Pelatihan & sertifikasi</p>
            </div>
            <div class="text-center p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="w-10 h-10 bg-emerald-100 rounded-xl flex items-center justify-center mx-auto mb-2">
                    <i class="fas fa-users text-emerald-600"></i>
                </div>
                <h3 class="font-semibold text-gray-900 text-xs lg:text-sm">Tim Solid</h3>
                <p class="text-[10px] lg:text-xs text-gray-500 mt-1 hidden sm:block">Profesional & suportif</p>
            </div>
            <div class="text-center p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <h3 class="font-semibold text-gray-900 text-xs lg:text-sm">Islami</h3>
                <p class="text-[10px] lg:text-xs text-gray-500 mt-1 hidden sm:block">Lingkungan kondusif</p>
            </div>
        </div>
        ...
        <div class="bg-gray-50 rounded-xl p-6 lg:p-8 text-center border border-gray-200 mb-6">
            ...
            <h3 class="font-bold text-gray-900 mb-1">Belum Ada Lowongan</h3>
            <p class="text-gray-500 text-sm mb-4">Saat ini belum ada posisi tersedia. Kirimkan CV Anda untuk database kami.</p>
            <a href="mailto:library@unida.gontor.ac.id?subject=Lamaran Kerja" class="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-lg text-sm font-medium hover:bg-primary-700 transition">
                <i class="fas fa-paper-plane"></i> Kirim CV
            </a>
        </div>
        ...
        <div class="bg-amber-50 rounded-xl p-4 border border-amber-200">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h3 class="font-bold text-gray-900 text-sm">Hubungi HRD</h3>
            </div>
