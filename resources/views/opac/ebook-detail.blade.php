<x-opac.layout :title="$ebook->title">
    <div class="lg:max-w-7xl lg:mx-auto lg:px-4 lg:py-8">
        ...
        <div class="relative bg-gradient-to-b from-orange-500 via-orange-600 to-red-600 lg:rounded-2xl lg:overflow-hidden">
            ...
            <div class="relative z-10 px-4 pt-4 lg:hidden">
                <a href="{{ route('opac.search') }}?type=ebook" class="inline-flex items-center gap-2 text-white/80 hover:text-white text-sm">
            ...
            <nav class="hidden lg:block relative z-10 px-6 pt-6 text-sm text-white/70">
                ...
                <span class="mx-2">/</span>
                <span class="text-white">{{ Str::limit($ebook->title, 40) }}</span>
            </nav>
