        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('auth.google') }}" class="w-full py-3 bg-white border-2 border-gray-200 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-300 transition mb-4">
                    ...
                    <p class="text-xs text-gray-400 text-center mb-4">Gunakan email @unida.gontor.ac.id untuk login atau registrasi otomatis</p>

                    <div class="relative my-5">
                        <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-gray-200"></div></div>
                        <div class="relative flex justify-center text-sm"><span class="px-3 bg-white text-gray-400">atau masuk manual</span></div>
                    </div>
                    @endif
