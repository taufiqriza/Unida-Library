<x-opac.layout title="Pengaturan Akun">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden" x-data="{ editMode: false }">
                        ...
                        <form action="{{ route('opac.member.settings.update') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                            @csrf
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', auth('member')->user()->name) }}" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-50 transition disabled:opacity-60 disabled:cursor-not-allowed" :disabled="!editMode" :class="editMode ? 'bg-white' : ''">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="phone" value="{{ old('phone', auth('member')->user()->phone) }}" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-50 transition disabled:opacity-60 disabled:cursor-not-allowed" :disabled="!editMode" :class="editMode ? 'bg-white' : ''">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="gender" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-50 transition disabled:opacity-60 disabled:cursor-not-allowed" :disabled="!editMode" :class="editMode ? 'bg-white' : ''">
                                            <option value="M" {{ auth('member')->user()->gender == 'M' ? 'selected' : '' }}>Laki-laki</option>
                                            <option value="F" {{ auth('member')->user()->gender == 'F' ? 'selected' : '' }}>Perempuan</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="md:col-span-2" x-show="editMode" x-collapse>
                                        ...
                                        <input type="file" name="photo" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100 transition border border-gray-200 rounded-xl p-1 bg-white">
                            ...
                            <div x-show="editMode" x-collapse>
                                <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-100 mt-2">
                                    ...
                                    <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-primary-600 to-primary-700 text-white text-sm font-bold rounded-xl shadow-lg shadow-primary-500/30 hover:shadow-xl hover:-translate-y-0.5 transition">
                                        Simpan Perubahan
                                    </button>
                                </div>
                            </div>
