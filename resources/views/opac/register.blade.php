                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-primary-600 to-primary-800 p-8 flex-col justify-center text-white">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium">Pinjam Buku</p>
                                    <p class="text-primary-200 text-sm">Hingga 3 eksemplar sekaligus</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center">
                                ...
                                <div>
                                    <p class="font-medium">Akses Digital</p>
                                    <p class="text-primary-200 text-sm">E-Book & E-Thesis 24/7</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center">
                    ...
                    <div class="lg:w-7/12">
                        ...
                        <div class="lg:hidden bg-gradient-to-r from-primary-600 to-primary-800 px-6 py-4 flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-lg font-bold text-white">Daftar Anggota</h1>
                                <p class="text-primary-200 text-sm">Buat akun perpustakaan Anda</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6 lg:p-8">
                            ...
                            <div class="hidden lg:block mb-6">
                                <h1 class="text-xl font-bold text-gray-900">Daftar Anggota Baru</h1>
                                <p class="text-gray-500 text-sm">Buat akun untuk akses perpustakaan</p>
                            </div>
                            ...
                            <a href="{{ route('auth.google') }}" class="w-full py-3 bg-white border-2 border-gray-200 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-300 transition mb-2">
                                ...
                                <span class="text-gray-700 font-medium">Daftar dengan Email UNIDA</span>
                            </a>
                            <p class="text-[11px] text-gray-400 text-center mb-4">Email @unida.gontor.ac.id untuk registrasi otomatis</p>

                            <div class="relative my-5">
                                <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-gray-200"></div></div>
                                <div class="relative flex justify-center text-xs"><span class="px-3 bg-white text-gray-400">atau daftar manual</span></div>
                            </div>
                            @endif

                            <form action="{{ route('opac.register') }}" method="POST" class="space-y-3">
                                @csrf
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" required placeholder="Masukkan nama lengkap"
                                            class="w-full pl-11 pr-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 transition">
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative" x-data="{ show: false }">
                                            ...
                                            <input :type="show ? 'text' : 'password'" name="password" required placeholder="Min 8 karakter"
                                                class="w-full pl-11 pr-10 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 transition">
