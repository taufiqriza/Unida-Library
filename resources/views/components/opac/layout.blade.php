...
<head>
    ...
    <style>
        /* Prevent FOUC - show loading screen until fully loaded */
        html { background: #eff6ff; }
        body { visibility: hidden; font-family: 'Inter', sans-serif; }
        body.loaded { visibility: visible; animation: fadeIn 0.15s ease-out; }
...
<script>
    // Wait for all resources to load then show body
                            ...
                            <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
                                ...
                                <div class="bg-gradient-to-r from-primary-600 to-blue-600 px-6 py-4 flex items-center justify-between">
                                    <div class="flex items-center gap-3 text-white">
                                        ...
                                        <span class="font-bold text-base">Jelajahi Koleksi Perpustakaan</span>
                                    </div>
                                            ...
                                            <div class="space-y-2 flex-1">
                                                ...
                                                <a href="{{ route('opac.page', 'digilib-apps') }}" class="block p-3 rounded-xl bg-gray-50 border border-gray-100 hover:shadow-md transition">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="min-w-0">
                                                            <p class="text-sm font-bold text-gray-900">Digilib Apps</p>
                                                            <p class="text-xs text-gray-500">Mobile & Desktop</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="space-y-3 flex-1">
                                                ...
                                                <div class="p-3 bg-gray-50 rounded-xl">
                                                    <p class="text-xs font-bold text-gray-500 mb-2">JURNAL UNIDA</p>
                                                ...
                                                <div class="p-3 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl border border-indigo-100">
                                                    <p class="text-xs font-bold text-indigo-600 mb-2 flex items-center gap-1">
                                                        <i class="fas fa-key text-xs"></i> KONSORSIUM FPPTI
                                                    </p>
