<div class="relative" x-data="{ open: false }">
    @php
        $flags = [
            ...
            'ar' => '<svg class="w-4 h-3 rounded-sm shadow-sm" viewBox="0 0 640 480"><path fill="#006c35" d="M0 0h640v480H0z"/><path fill="#fff" d="M0 0h640v320H0z"/><path fill="#000" d="M0 0h640v160H0z"/></svg>',
        ];
    @endphp
